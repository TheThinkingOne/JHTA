...
<main class="form-signin w-100 m-auto">
    <form action="login-member-process.jsp" method="post">
        <img class="mb-4" src="../images/lenu.jpg" alt="" width="72" height="72">
        <h1 class="h3 mb-3 fw-normal">Please log in</h1>

        <div class="form-floating">
            <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="userID" value="${cookie.loggedID.value}">
