...
public class StudentManager_HashMapVer {
    ...
    private void read() {
        ...
        for (int i=0; i<4; i++) {
            ...
            students.put(name,student); // key: name, value: student
...
//
//        }
        Set<String> keyList = students.keySet(); // 해시맵으로 하는것
        Iterator<String> iterator = keyList.iterator();

        while (iterator.hasNext()) {

            String selectedName = iterator.next();
            Student student = students.get(selectedName); // student
