...
public class Sol5_imageCompare {
...
//                }
    ...
    public static void main(String[] args) {
        try { // 파일리더, 스트림, 파일 등등 하나의 트라이캐치 문 안에 넣고 예외처리 가능
            FileInputStream text01 = new FileInputStream("C:\\Users\\jhta\\Desktop\\myFolder\\newEmmaScreen.png");
            FileInputStream text02 = new FileInputStream("C:\\Users\\jhta\\Desktop\\myFolder\\forCompare\\newEmmaScreen.png");
